...
//#region node_modules/.nitro/vite/services/ssr/assets/router-C0PC7-g8.js
var router_C0PC7_g8_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-B8kIUzWy.css";
var APP_NAME = "PAL";
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "PAL is a memory map over people, work, and business context — capture, connect, then act."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-BBGeGDmH.mjs");
var Route$1 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var Route = createFileRoute("/api/webhooks/svix")({ server: { handlers: { POST: async ({ request }) => {
	const { env } = await import("./env.server-DRkkE6Ij.mjs");
	const { storeInbound } = await import("./inbound.server-DEaQW5as.mjs");
	const payload = await request.text();
	const secret = env("SVIX_WEBHOOK_SECRET");
	if (secret) {
		const { Webhook } = await import("../_libs/svix.mjs").then((n) => n.t);
		const headers = {
...
var rootRouteChildren = {
	...
	ApiWebhooksSvixRoute: Route.update({
...
//#endregion
export { getRouter, router_C0PC7_g8_exports as t };
