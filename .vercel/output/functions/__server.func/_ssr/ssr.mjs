...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C0cmSmIf.mjs");
...
var manifest = {
	"262e1e7729e31167c8143007e98f9ff4b87aeb9a4dfdf22f12ed47206dfdc193": {
		functionName: "publishSvixAnalysis_createServerFn_handler",
		importer: () => import("./integrations.functions-D665qG7z.mjs")
	},
	"4b637085f7b336e78fcaae4d046f3c30d8411f634ee1dce80c84532100cc17e6": {
		functionName: "transcribeAudio_createServerFn_handler",
		importer: () => import("./integrations.functions-D665qG7z.mjs")
	},
	"8fe57a24e5142a383fd82bf6eac60cc1e65172bf2a22bad6240823b767ab3d4c": {
		functionName: "getIntegrationStatus_createServerFn_handler",
		importer: () => import("./integrations.functions-D665qG7z.mjs")
	},
	"992f4897c81b9a868d9526cb9c2e7661866a942a95bb0725a579c62e99bceafe": {
		functionName: "getInboundTranscript_createServerFn_handler",
		importer: () => import("./integrations.functions-D665qG7z.mjs")
	},
	"c3dbac3d31ca690bac979e793975bb05890cf2945d9bfe9910894dd3963d6175": {
		functionName: "addSvixEndpoint_createServerFn_handler",
		importer: () => import("./integrations.functions-D665qG7z.mjs")
	},
	"fcda446d878d91b276f56bb884aa22613b7de707b2fa2230561d8c1f7e3a3eb3": {
		functionName: "enrichWithOpenRouter_createServerFn_handler",
		importer: () => import("./integrations.functions-D665qG7z.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C0PC7-g8.mjs").then((n) => n.t),
